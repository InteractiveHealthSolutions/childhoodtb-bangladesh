...
public class BarcodeIntentIntegrator {
	...
	public static final int REQUEST_CODE = 0x0000c0de; // Only
														...
														// 16
														// bits
	private static final String TAG = BarcodeIntentIntegrator.class
			.getSimpleName();
	 ...
	 *         else an {@link BarcodeIntentResult} containing the result of the
	 *         scan. If the user cancelled scanning, the fields will be null.
	 */
	public static BarcodeIntentResult parseActivityResult(int requestCode,
		...
		if (requestCode == REQUEST_CODE) {
			if (resultCode == Activity.RESULT_OK) {
				...
				return new BarcodeIntentResult(contents, formatName, rawBytes,
