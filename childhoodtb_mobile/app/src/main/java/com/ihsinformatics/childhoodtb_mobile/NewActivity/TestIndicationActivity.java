...
public class TestIndicationActivity extends AbstractFragmentActivity {
    ...
    MyEditText histopathologySampleEditText;
    ...
    public void createViews(Context context) {
        ...
        histopathologySampleEditText = new MyEditText(context, R.string.histopathology_sample,
        ...
        View[][] viewGroups = {
                {formDateTextView, formDateButton, screeningFacilityTextView, screeningFacilityOptions,
                        chestXrayTextView, chestXraySpinner, ctScanAreaTextView, ctScanAreaEditText,
                        ultrasoundAbdomenTextView, ultrasoundAbdomenSpinner, ctScanTextView, ctScanSpinner
                },
                {mantouxTextView, mantouxSpinner, smearMicroscopyTextView,
                        smearMicroscopySpinner, xpertMTBRIFTextView, xpertMTBRIFSpinner,
                        histopathologyTextView, histopathologySpinner, histopathologySampleTextView,
                        histopathologySampleEditText
                },
                {esrTextView, esrSpinner, patientIdTextView, patientId, scanBarcode
                }
        };
        ...
        views = new View[]{screeningFacilityOptions, ctScanSpinner, chestXraySpinner,
                ultrasoundAbdomenSpinner, esrSpinner, xpertMTBRIFSpinner, histopathologySampleEditText, histopathologySpinner,
