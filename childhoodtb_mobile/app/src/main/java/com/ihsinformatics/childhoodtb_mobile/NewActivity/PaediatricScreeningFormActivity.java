...
public class PaediatricScreeningFormActivity extends AbstractFragmentActivity implements TextView.OnEditorActionListener {
  ...
  /*  MyTextView screeningFacilityTextView;
    ...
    public void createViews(Context context) {
        ...
        View[][] viewGroups = {
                {formDateTextView, formDateButton,firstNameTextView, screenedBeforeTextView, screenedBefore,firstName, lastNameTextView, lastName,
                        genderTextView, gender, ageTextView, age
                },
                {dobTextView, dobPicker, contactHistoryConclusionTextView,ageModifierTextView, ageModifier,
                        contactHistoryConclusion
                },
                {presumptiveTbCaseTextView, presumptiveTbCase, smokingConfirmationTextView, smokingConfirmation, coughTextView, cough,
                        coughDurationTextView, coughDuration,
                        feverTextView, fever, nightSweatsTextView, nightSweats
                },

                {weightLossTextView, weightLoss, childAppetiteTextView, childAppetite, patientIdTextView, patientId, scanBarcode}
        };
