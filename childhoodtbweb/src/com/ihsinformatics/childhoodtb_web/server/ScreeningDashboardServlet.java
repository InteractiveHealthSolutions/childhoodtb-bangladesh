 ...
 *
 */
public class ScreeningDashboardServlet extends HttpServlet
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -7410299612665813970L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		if(request.getParameter("Logout") != null)
		{
			...
			rd = request.getRequestDispatcher("/screeningdashboardlogin.jsp");
		...
		{
			response.setContentType("text/csv");
			String filename = "ScreeningData-" + String.valueOf(new Date().getTime()) + ".csv";
			String disposition = "attachment; filename=" + filename;
			response.setHeader("Content-Disposition", disposition);
